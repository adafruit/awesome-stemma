...
| [ESP32-S2 Feather 4MB Flash / 2MB PSRAM](https://www.adafruit.com/product/5477) | 1 Stemma QT | ESP32-S2, 4MB Flash, 2MB PSRAM, WiFi |
...
| [Quad Alphanumeric Display 4 Digits](https://www.adafruit.com/product/1911) | 2 Stemma QT | Five single color displays available, 0.54" height digits |
...
| Vendor | Item | Features |
|---|---|---|
| Adafruit | [QT 3V to 5V Level Booster Breakout](https://www.adafruit.com/product/5649) | 2 Stemma QT connectors, 3V to 5V signal level booster |
